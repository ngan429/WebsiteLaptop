	...
	<form action="ThongTinSanPhamDB" method="post">
		...
		<section class="body_product">
			<div class="container">
				...
				<br /> <span>Thêm Sản Phẩm:</span> <a
					href="InsertThongTinSanPhamDB">Add Sản Phẩm</a>
					...
					<table border=1>
						...
						<c:forEach items="${listThongTinSanPham}" var="ttsp"
							...
							<tr>
								...
								<td><a class="delete-edit" href="LoadEditThongTinSanPhamDB?maSP=${ttsp.maSP}">Edit</a><a class="delete-edit"
