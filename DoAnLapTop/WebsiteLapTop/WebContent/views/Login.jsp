	...
	<div class="content-w3ls">
		<div class="content-agile2">
			<form action="LoginServlet" method="post">
				<i style="color: red" class="alert">${message}</i>
				<div class="">
				...
				<div class="forget">
					<a style="color: white" href="TrangChuNoLoginServlet">Return
						Shop</a> <a style="color: white" href="RegisterServlet">Register</a>
				</div>
