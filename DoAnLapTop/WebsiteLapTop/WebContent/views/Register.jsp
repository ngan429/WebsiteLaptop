...
<!-- /css -->
<style type="text/css">
input#username, input#fullname, input#email, input#password1, input#password2,
	input#phone, input#birthday {
	width: 500px;
	height: 50px;
	padding: 0 15px;
	color: #fff;
			...
			<form action="RegisterServlet" method="post">
				<div class="form-control w3layouts">
					<input type="text" id="username" name="username"
						placeholder="User Name" title="Please enter your User Name"
						required="">
				</div>

				<div class="form-control w3layouts">
					<input type="text" id="fullname" name="fullname"
						placeholder="Full Name" title="Please enter your Full Name"
						required="">
				</div>
